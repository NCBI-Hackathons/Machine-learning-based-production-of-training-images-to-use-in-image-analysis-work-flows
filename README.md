...
We use a tool called Docker, which can package all our work including code and enviroment in one docker image.
Thanks to Containerization, you can use our tools without many setup steps. Just follow the instruction below :
2-1. docker pull johnbamboobilly/ragan
https://hub.docker.com/r/johnbamboobilly/ragan/
the link is our repository on dockerhub
2-2. docker image ls
check the IMAGE ID in the list, and copy the IMAGE ID you just pulled down
2-3. docker run <IMAGE ID>
